...
const FileProcessingRequirementsTable: React.FC = () => {
      ...
      try {
        ...
        const transformedData = fileprocessingRequirementsData.map(
          (fileprocessingrequirements: FileProcessingRequirements) => {
            ...
            return {
              key: fileprocessingrequirements.id,
              title: fileprocessingrequirements.title,
              description: fileprocessingrequirements.description,
  ...
  const handleConfirmDelete = async () => {
    ...
    await axios.delete(`/api/fileprocessingapi/fileprocessingrequirements/${selectedId}`);
      ...
      <Layout style={{ marginLeft: siderWidth }}>
        ...
        <Content style={contentStyle}>
          ...
          <Drawer
            title={
              formType === "edit"
                ? "Edit fileprocessing Requirement"
                : "Add fileprocessing Requirement"
            }
            placement={placement}
            closable={false}
            onClose={onClose}
            ...
            width={600}
          >
            {formType === "edit" && <FileProcessingRequirements id={selectedId} />}
            {formType === "add" && <FileProcessingRequirements addid={countryid} />}
          </Drawer>
        </Content>
      </Layout>
    </Layout>
...
export default FileProcessingRequirementsTable;
