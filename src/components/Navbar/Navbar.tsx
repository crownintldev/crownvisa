...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full py-1 lg:backdrop-blur-lg lg:opacity-90 container mx-auto px-4 z-10">
      <div>
        <Image
      ...
      <div
        className="text-3xl lg:hidden flex justify-center items-center mr-7"
        onClick={() => setOpen(!open)}
      >
        <AiOutlineMenuFold />
      </div>
      <div className="lg:flex hidden">
        <ul className="lg:flex uppercase items-center gap-4 antialiased mr-4">
          <li>
            <Link
              href="/"
    ...
    `}
      >
        ...
        <ul>
          ...
          <li onClick={toggleDropdown} className="flex flex-col group relative">
